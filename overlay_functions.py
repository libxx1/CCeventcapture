...
overlays = ['girl', 'cowboy', 'computer', 'top', 'pink', 'music', 'glassesnose', 'moustache', 'robotpink', 'sunglasses', 'elvis', 'robotsideblue', 'emo', 'blackhat', 'rocket', 'emo2', 'baseball', 'flowers', 'santa', 'alps', 'mop', 'glasses']
# ------------------------------------------
